...
def lines(xstart, ystart, xend, yend, color=None, n_segments=100,
          comet=False, opp_comet=False, transparent=False, opp_transparent=False, alpha_start=0.01,
    ...
    opp_comet : bool default False
        Whether to plot the lines decreasing in width.
    transparent : bool, default False
        Whether to plot the lines increasing in opacity.
    opp_transparent : bool, default False
        Whether to plot the lines decreasing in opacity.
    ...
    **kwargs : All other keyword arguments are passed on to matplotlib.collections.LineCollection.
    ...
    if opp_comet:
        lw = np.linspace(lw, 1, n_segments)

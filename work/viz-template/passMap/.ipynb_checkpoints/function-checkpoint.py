...
def plotHeatMap(df,playerId,ax):
    ...
    if playerId is not None:
        pdf = df[df['playerId']==playerId]
    pdf = df
    cmap = mpl.colors.LinearSegmentedColormap.from_list('cmap', ["#131313","#D61327"]) #13B9D6
...
def plotHeatMap2(df,playerId,pitch,ax,time=None,time2=None):
    ...
    cmapA = LinearSegmentedColormap.from_list("my_cmap", [pitchColor,"#442D2D", "#852626", "#CB1C1C", "#FF0000"], N=100)

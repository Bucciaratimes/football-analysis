...
#             fontsize=12, ha='center')
    ...
    ax.scatter(x=home_goals, y=home_y, s=200, facecolor=home_color, edgecolor='k', marker="*")
...
#     imscatter(x=away_goals, y=away_y, image='utils/football.png', ax=ax, zoom=0.1)
    ax.scatter(x=away_goals, y=away_y, s=200, facecolor=away_color, edgecolor='k', marker="*")

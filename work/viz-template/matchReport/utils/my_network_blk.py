...
def main(match_data, axHome, axAway):
    ...
    axHome.text(x=11,y=124,s=f'{homeFormation} (Avg-Age {homeAge})',color='#111111', fontsize=28, fontname="cmb10")
    axAway.text(x=11,y=124,s=f'{awayFormation} (Avg-Age {awayAge})',color='#111111', fontsize=28, fontname="cmb10")
